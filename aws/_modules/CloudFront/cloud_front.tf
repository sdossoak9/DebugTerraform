...
resource "aws_cloudfront_distribution" "s3_distribution" {
  # oak9: cloud_front.distribution.distribution_config.origins[0].connection_timeout is not configured
  ...
  default_cache_behavior {
    ...
    # oak9: cloud_front.distribution.distribution_config.default_cache_behavior.allowed_methods are not configured to allow only minimum necessary HTTP methods
    cached_methods   = ["GET", "HEAD"]
