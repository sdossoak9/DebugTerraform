...
resource "aws_cloudfront_distribution" "s3_distribution" {
  ...
  # oak9: cloud_front.distribution.distribution_config.default_cache_behavior.cache_policy_id is not configured
  ...
  # oak9: cloud_front.distribution.distribution_config.default_cache_behavior.field_level_encryption_id is not configured
  # oak9: cloud_front.distribution.distribution_config.origins[0].connection_attempts is not configured
